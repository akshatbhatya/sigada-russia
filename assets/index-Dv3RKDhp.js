...
const qO = [
        {
            icon: "ðŸ¦·",
            title: "Ð›ÐµÑ‡ÐµÐ½Ð¸Ðµ Ð·ÑƒÐ±Ð¾Ð²",
            desc: "Ð¡Ð¾Ð²Ñ€ÐµÐ¼ÐµÐ½Ð½Ñ‹Ðµ Ð¼ÐµÑ‚Ð¾Ð´Ñ‹ Ð»ÐµÑ‡ÐµÐ½Ð¸Ñ ÐºÐ°Ñ€Ð¸ÐµÑÐ°, Ð¿ÑƒÐ»ÑŒÐ¿Ð¸Ñ‚Ð° Ð¸ Ð·Ð°Ð±Ð¾Ð»ÐµÐ²Ð°Ð½Ð¸Ð¹ Ð¿ÐµÑ€Ð¸Ð¾Ð´Ð¾Ð½Ñ‚Ð° Ñ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¸ÐµÐ¼ Ð¿ÐµÑ€ÐµÐ´Ð¾Ð²Ñ‹Ñ… ÐµÐ²Ñ€Ð¾Ð¿ÐµÐ¹ÑÐºÐ¸Ñ… Ð¼Ð°Ñ‚ÐµÑ€Ð¸Ð°Ð»Ð¾Ð².",
            img_url: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_db74ef7b98_0af09242dbc01c52.png",
        },
        {
            icon: "âœ¨",
            title: "ÐŸÑ€Ð¾Ñ„ÐµÑÑÐ¸Ð¾Ð½Ð°Ð»ÑŒÐ½Ð°Ñ Ñ‡Ð¸ÑÑ‚ÐºÐ°",
            desc: "Ð£Ð»ÑŒÑ‚Ñ€Ð°Ð·Ð²ÑƒÐºÐ¾Ð²Ð¾Ðµ ÑƒÐ´Ð°Ð»ÐµÐ½Ð¸Ðµ Ð·ÑƒÐ±Ð½Ð¾Ð³Ð¾ ÐºÐ°Ð¼Ð½Ñ Ð¸ Air Flow Ð¿Ð¾Ð»Ð¸Ñ€Ð¾Ð²ÐºÐ° Ð´Ð»Ñ Ð±ÐµÐ·ÑƒÐ¿Ñ€ÐµÑ‡Ð½Ð¾ Ñ‡Ð¸ÑÑ‚Ð¾Ð¹ ÑƒÐ»Ñ‹Ð±ÐºÐ¸ Ð¿Ð¾ÑÐ»Ðµ ÐºÐ°Ð¶Ð´Ð¾Ð³Ð¾ Ð²Ð¸Ð·Ð¸Ñ‚Ð°.",
            img_url: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_790a091a0d_a20ee837702b56bf.png",
        },
        {
            icon: "ðŸ”©",
            title: "Ð˜Ð¼Ð¿Ð»Ð°Ð½Ñ‚Ð°Ñ†Ð¸Ñ",
            desc: "Ð¨Ð²ÐµÐ¹Ñ†Ð°Ñ€ÑÐºÐ¸Ðµ Ð¸ Ð½ÐµÐ¼ÐµÑ†ÐºÐ¸Ðµ Ð¸Ð¼Ð¿Ð»Ð°Ð½Ñ‚Ð°Ñ‚Ñ‹ Ñ Ð¿Ð¾Ð¶Ð¸Ð·Ð½ÐµÐ½Ð½Ð¾Ð¹ Ð³Ð°Ñ€Ð°Ð½Ñ‚Ð¸ÐµÐ¹. ÐŸÐ¾Ð»Ð½Ð¾Ðµ Ð²Ð¾ÑÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸ Ð¸ ÑÑÑ‚ÐµÑ‚Ð¸ÐºÐ¸ Ð·ÑƒÐ±Ð½Ð¾Ð³Ð¾ Ñ€ÑÐ´Ð°.",
            img_url: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_a9d3c23836_8c18afe2f864daf1.png",
        },
        {
            icon: "â­",
            title: "ÐžÑ‚Ð±ÐµÐ»Ð¸Ð²Ð°Ð½Ð¸Ðµ Ð·ÑƒÐ±Ð¾Ð²",
            desc: "Ð¡Ð¸ÑÑ‚ÐµÐ¼Ð° Zoom 4 Ð¸ Beyond Ð´Ð»Ñ Ð´Ð¾ÑÑ‚Ð¸Ð¶ÐµÐ½Ð¸Ñ Ð±ÐµÐ»Ð¾ÑÐ½ÐµÐ¶Ð½Ð¾Ð¹ ÑƒÐ»Ñ‹Ð±ÐºÐ¸ Ð´Ð¾ 8 Ð¾Ñ‚Ñ‚ÐµÐ½ÐºÐ¾Ð² ÑÐ²ÐµÑ‚Ð»ÐµÐµ Ð²ÑÐµÐ³Ð¾ Ð·Ð° Ð¾Ð´Ð¸Ð½ Ð²Ð¸Ð·Ð¸Ñ‚.",
            img_url: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_115b7c05ec_43449788e8c293ba.png",
        },
        {
            icon: "ðŸ§¸",
            title: "Ð”ÐµÑ‚ÑÐºÐ°Ñ ÑÑ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³Ð¸Ñ",
            desc: "Ð‘ÐµÑ€ÐµÐ¶Ð½Ñ‹Ð¹ Ð¸ Ð±ÐµÐ·Ð±Ð¾Ð»ÐµÐ·Ð½ÐµÐ½Ð½Ñ‹Ð¹ Ð¿Ð¾Ð´Ñ…Ð¾Ð´ Ðº Ð»ÐµÑ‡ÐµÐ½Ð¸ÑŽ Ð·ÑƒÐ±Ð¾Ð² Ñƒ Ð´ÐµÑ‚ÐµÐ¹. Ð¡Ð¾Ð·Ð´Ð°Ñ‘Ð¼ Ð¿Ð¾Ð·Ð¸Ñ‚Ð¸Ð²Ð½Ñ‹Ð¹ Ð¾Ð¿Ñ‹Ñ‚ Ñ ÑÐ°Ð¼Ð¾Ð³Ð¾ Ð¿ÐµÑ€Ð²Ð¾Ð³Ð¾ Ð²Ð¸Ð·Ð¸Ñ‚Ð°.",
            img_url: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_1e816ca8c1_5c2e1b31b4359289.png",
        },
        {
            icon: "ðŸ˜",
            title: "ÐžÑ€Ñ‚Ð¾Ð´Ð¾Ð½Ñ‚Ð¸Ñ",
            desc: "Ð­Ð»Ð°Ð¹Ð½ÐµÑ€Ñ‹ Invisalign Ð¸ ÑÑÑ‚ÐµÑ‚Ð¸Ñ‡ÐµÑÐºÐ¸Ðµ Ð±Ñ€ÐµÐºÐµÑ‚Ñ‹ Ð´Ð»Ñ Ð¸Ð´ÐµÐ°Ð»ÑŒÐ½Ð¾Ð³Ð¾ Ð¿Ñ€Ð¸ÐºÑƒÑÐ°. ÐÐµÐ·Ð°Ð¼ÐµÑ‚Ð½Ð¾Ðµ Ð¸ÑÐ¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ Ð² Ð»ÑŽÐ±Ð¾Ð¼ Ð²Ð¾Ð·Ñ€Ð°ÑÑ‚Ðµ.",
            img_url: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_7a4a0e542e_1a4faff951a17a4f.png",
        },
    ],
    ZO = [
        { value: 12, suffix: "+", label: "Ð›ÐµÑ‚ Ð¾Ð¿Ñ‹Ñ‚Ð°" },
        { value: 3800, suffix: "+", label: "ÐŸÐ°Ñ†Ð¸ÐµÐ½Ñ‚Ð¾Ð²" },
        { value: 98, suffix: "%", label: "Ð”Ð¾Ð²Ð¾Ð»ÑŒÐ½Ñ‹Ñ… ÐºÐ»Ð¸ÐµÐ½Ñ‚Ð¾Ð²" },
        { value: 15, suffix: "+", label: "ÐÐ°Ð³Ñ€Ð°Ð´" },
    ],
    _y = [
        {
            name: "ÐÐ½Ð°ÑÑ‚Ð°ÑÐ¸Ñ Ðš.",
            role: "ÐŸÐ°Ñ†Ð¸ÐµÐ½Ñ‚, 3 Ð³Ð¾Ð´Ð°",
            text: "Ð¡Ð°Ð³Ð¸Ð´Ð° Ð­Ð»ÑŒÐ´Ð°Ñ€Ð¾Ð²Ð½Ð° â€” Ð½Ð°ÑÑ‚Ð¾ÑÑ‰Ð¸Ð¹ Ð¿Ñ€Ð¾Ñ„ÐµÑÑÐ¸Ð¾Ð½Ð°Ð». ÐžÑ‡ÐµÐ½ÑŒ Ð²Ð½Ð¸Ð¼Ð°Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ð¹ Ð²Ñ€Ð°Ñ‡, Ð¾Ð±ÑŠÑÑÐ½Ð¸Ð»Ð° ÐºÐ°Ð¶Ð´Ñ‹Ð¹ ÑˆÐ°Ð³ Ð»ÐµÑ‡ÐµÐ½Ð¸Ñ. Ð’Ð¿ÐµÑ€Ð²Ñ‹Ðµ Ð½Ðµ Ð±Ð¾ÑŽÑÑŒ Ð¸Ð´Ñ‚Ð¸ Ðº ÑÑ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³Ñƒ!",
            rating: 5,
            avatar: "https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-1.jpg",
        },
        {
            name: "ÐœÐ¸Ñ…Ð°Ð¸Ð» Ð .",
            role: "ÐŸÐ°Ñ†Ð¸ÐµÐ½Ñ‚, 1 Ð³Ð¾Ð´",
            text: "Ð¡Ð´ÐµÐ»Ð°Ð» Ð¸Ð¼Ð¿Ð»Ð°Ð½Ñ‚Ð°Ñ†Ð¸ÑŽ Ð´Ð²ÑƒÑ… Ð·ÑƒÐ±Ð¾Ð². Ð ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚ Ð¿Ñ€ÐµÐ²Ð·Ð¾ÑˆÑ‘Ð» Ð²ÑÐµ Ð¾Ð¶Ð¸Ð´Ð°Ð½Ð¸Ñ â€” Ð²Ñ‹Ð³Ð»ÑÐ´Ð¸Ñ‚ Ð°Ð±ÑÐ¾Ð»ÑŽÑ‚Ð½Ð¾ ÐµÑÑ‚ÐµÑÑ‚Ð²ÐµÐ½Ð½Ð¾. ÐšÐ»Ð¸Ð½Ð¸ÐºÐ° Ð²Ñ‹ÑÑˆÐµÐ³Ð¾ ÐºÐ»Ð°ÑÑÐ°.",
            rating: 5,
            avatar: "https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-2.jpg",
        },
        {
            name: "Ð•Ð»ÐµÐ½Ð° Ð’.",
            role: "ÐŸÐ°Ñ†Ð¸ÐµÐ½Ñ‚, 2 Ð³Ð¾Ð´Ð°",
            text: "ÐŸÑ€Ð¾Ð²ÐµÐ»Ð° Ð¾Ñ‚Ð±ÐµÐ»Ð¸Ð²Ð°Ð½Ð¸Ðµ Ð¿Ð¾ ÑÐ¸ÑÑ‚ÐµÐ¼Ðµ Zoom. Ð ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚ Ð¿Ð¾Ñ‚Ñ€ÑÑÐ°ÑŽÑ‰Ð¸Ð¹! Ð—ÑƒÐ±Ñ‹ Ð½Ð° 7 Ð¾Ñ‚Ñ‚ÐµÐ½ÐºÐ¾Ð² ÑÐ²ÐµÑ‚Ð»ÐµÐµ. Ð ÐµÐºÐ¾Ð¼ÐµÐ½Ð´ÑƒÑŽ Ð²ÑÐµÐ¼ ÑÐ²Ð¾Ð¸Ð¼ Ð´Ñ€ÑƒÐ·ÑŒÑÐ¼.",
            rating: 5,
            avatar: "https://storage.googleapis.com/uxpilot-auth.appspot.com/avatars/avatar-5.jpg",
        },
        {
            name: "Ð”Ð¼Ð¸Ñ‚Ñ€Ð¸Ð¹ ÐŸ.",
            role: "ÐŸÐ°Ñ†Ð¸ÐµÐ½Ñ‚, 4 Ð³Ð¾Ð´Ð°",
            text: "ÐŸÑ€Ð¸Ð²Ð¾Ð¶Ñƒ Ð²ÑÑŽ ÑÐµÐ¼ÑŒÑŽ Ð²ÐºÐ»ÑŽÑ‡Ð°Ñ Ð´ÐµÑ‚ÐµÐ¹. Ð ÐµÐ±Ñ‘Ð½Ð¾Ðº ÑÐ°Ð¼ Ð¿Ñ€Ð¾ÑÐ¸Ñ‚ÑÑ Ðº Ð¡Ð°Ð³Ð¸Ð´Ðµ Ð­Ð»ÑŒÐ´Ð°Ñ€Ð¾Ð²Ð½Ðµ â€” ÑÑ‚Ð¾ Ð»Ð¸ Ð½Ðµ Ð»ÑƒÑ‡ÑˆÐ°Ñ Ñ€ÐµÐºÐ¾Ð¼ÐµÐ½Ð´Ð°Ñ†Ð¸Ñ!",
            rating: 5,
    ...
    JO = [
        {
            q: "Ð‘Ð¾Ð»ÑŒÐ½Ð¾ Ð»Ð¸ Ð´ÐµÐ»Ð°Ñ‚ÑŒ Ð¸Ð¼Ð¿Ð»Ð°Ð½Ñ‚Ð°Ñ†Ð¸ÑŽ Ð·ÑƒÐ±Ð¾Ð²?",
            a: "ÐÐµÑ‚. Ð˜Ð¼Ð¿Ð»Ð°Ð½Ñ‚Ð°Ñ†Ð¸Ñ Ð¿Ñ€Ð¾Ð²Ð¾Ð´Ð¸Ñ‚ÑÑ Ð¿Ð¾Ð´ Ð¼ÐµÑÑ‚Ð½Ð¾Ð¹ Ð°Ð½ÐµÑÑ‚ÐµÐ·Ð¸ÐµÐ¹. Ð¡Ð¾Ð²Ñ€ÐµÐ¼ÐµÐ½Ð½Ñ‹Ðµ Ð°Ð½ÐµÑÑ‚ÐµÑ‚Ð¸ÐºÐ¸ Ð¾Ð±ÐµÑÐ¿ÐµÑ‡Ð¸Ð²Ð°ÑŽÑ‚ Ð¿Ð¾Ð»Ð½Ð¾Ðµ Ð¾Ñ‚ÑÑƒÑ‚ÑÑ‚Ð²Ð¸Ðµ Ð±Ð¾Ð»Ð¸ Ð²Ð¾ Ð²Ñ€ÐµÐ¼Ñ Ð¿Ñ€Ð¾Ñ†ÐµÐ´ÑƒÑ€Ñ‹. ÐŸÐ¾ÑÐ»Ðµ Ð¾Ð¿ÐµÑ€Ð°Ñ†Ð¸Ð¸ Ð²Ð¾Ð·Ð¼Ð¾Ð¶ÐµÐ½ ÑƒÐ¼ÐµÑ€ÐµÐ½Ð½Ñ‹Ð¹ Ð´Ð¸ÑÐºÐ¾Ð¼Ñ„Ð¾Ñ€Ñ‚ Ð½Ð° 1â€“2 Ð´Ð½Ñ.",
        },
        {
            q: "Ð¡ÐºÐ¾Ð»ÑŒÐºÐ¾ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð¸ Ð·Ð°Ð½Ð¸Ð¼Ð°ÐµÑ‚ Ð¾Ñ‚Ð±ÐµÐ»Ð¸Ð²Ð°Ð½Ð¸Ðµ Zoom?",
            a: "ÐŸÑ€Ð¾Ñ†ÐµÐ´ÑƒÑ€Ð° Ð¾Ñ‚Ð±ÐµÐ»Ð¸Ð²Ð°Ð½Ð¸Ñ Zoom 4 Ð·Ð°Ð½Ð¸Ð¼Ð°ÐµÑ‚ Ð¾ÐºÐ¾Ð»Ð¾ 90 Ð¼Ð¸Ð½ÑƒÑ‚. Ð ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚ Ð²Ð¸Ð´ÐµÐ½ ÑÑ€Ð°Ð·Ñƒ â€” Ð·ÑƒÐ±Ñ‹ ÑÑ‚Ð°Ð½Ð¾Ð²ÑÑ‚ÑÑ Ð½Ð° 6â€“8 Ð¾Ñ‚Ñ‚ÐµÐ½ÐºÐ¾Ð² ÑÐ²ÐµÑ‚Ð»ÐµÐµ. Ð­Ñ„Ñ„ÐµÐºÑ‚ ÑÐ¾Ñ…Ñ€Ð°Ð½ÑÐµÑ‚ÑÑ Ð´Ð¾ 2 Ð»ÐµÑ‚ Ð¿Ñ€Ð¸ ÑÐ¾Ð±Ð»ÑŽÐ´ÐµÐ½Ð¸Ð¸ Ñ€ÐµÐºÐ¾Ð¼ÐµÐ½Ð´Ð°Ñ†Ð¸Ð¹.",
        },
        {
            q: "ÐœÐ¾Ð¶Ð½Ð¾ Ð»Ð¸ Ð»ÐµÑ‡Ð¸Ñ‚ÑŒ Ð·ÑƒÐ±Ñ‹ Ð²Ð¾ Ð²Ñ€ÐµÐ¼Ñ Ð±ÐµÑ€ÐµÐ¼ÐµÐ½Ð½Ð¾ÑÑ‚Ð¸?",
            a: "Ð”Ð°, Ð»ÐµÑ‡ÐµÐ½Ð¸Ðµ Ð·ÑƒÐ±Ð¾Ð² Ð±ÐµÐ·Ð¾Ð¿Ð°ÑÐ½Ð¾ Ð¸ Ð´Ð°Ð¶Ðµ Ñ€ÐµÐºÐ¾Ð¼ÐµÐ½Ð´Ð¾Ð²Ð°Ð½Ð¾ Ð²Ð¾ Ð²Ñ‚Ð¾Ñ€Ð¾Ð¼ Ñ‚Ñ€Ð¸Ð¼ÐµÑÑ‚Ñ€Ðµ. ÐœÑ‹ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·ÑƒÐµÐ¼ Ð±ÐµÐ·Ð¾Ð¿Ð°ÑÐ½Ñ‹Ðµ Ð°Ð½ÐµÑÑ‚ÐµÑ‚Ð¸ÐºÐ¸ Ð¸ Ð¼ÐµÑ‚Ð¾Ð´Ñ‹, Ð¾Ð´Ð¾Ð±Ñ€Ñ‘Ð½Ð½Ñ‹Ðµ Ð´Ð»Ñ Ð±ÐµÑ€ÐµÐ¼ÐµÐ½Ð½Ñ‹Ñ…. ÐžÐ±ÑÐ·Ð°Ñ‚ÐµÐ»ÑŒÐ½Ð¾ ÑÐ¾Ð¾Ð±Ñ‰Ð¸Ñ‚Ðµ Ð¾ Ð±ÐµÑ€ÐµÐ¼ÐµÐ½Ð½Ð¾ÑÑ‚Ð¸ Ð¿ÐµÑ€ÐµÐ´ Ð²Ð¸Ð·Ð¸Ñ‚Ð¾Ð¼.",
        },
        {
            q: "ÐšÐ°Ðº Ð·Ð°Ð¿Ð¸ÑÐ°Ñ‚ÑŒÑÑ Ð½Ð° Ð¿ÐµÑ€Ð²Ð¸Ñ‡Ð½Ñ‹Ð¹ Ð¿Ñ€Ð¸Ñ‘Ð¼?",
            a: "Ð’Ñ‹ Ð¼Ð¾Ð¶ÐµÑ‚Ðµ Ð·Ð°Ð¿Ð¸ÑÐ°Ñ‚ÑŒÑÑ Ð¿Ð¾ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½Ñƒ +7 (747) 123-45-67, Ñ‡ÐµÑ€ÐµÐ· WhatsApp Ð¸Ð»Ð¸ Ð¾ÑÑ‚Ð°Ð²Ð¸Ð² Ð·Ð°ÑÐ²ÐºÑƒ Ð½Ð° ÑÐ°Ð¹Ñ‚Ðµ. ÐŸÐµÑ€Ð²Ð¸Ñ‡Ð½Ð°Ñ ÐºÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†Ð¸Ñ Ð·Ð°Ð½Ð¸Ð¼Ð°ÐµÑ‚ 30â€“45 Ð¼Ð¸Ð½ÑƒÑ‚. ÐœÑ‹ Ñ€Ð°Ð±Ð¾Ñ‚Ð°ÐµÐ¼ ÐµÐ¶ÐµÐ´Ð½ÐµÐ²Ð½Ð¾ Ñ 9:00 Ð´Ð¾ 20:00.",
        },
        {
            q: "ÐŸÑ€Ð¸Ð½Ð¸Ð¼Ð°ÐµÑ‚Ðµ Ð»Ð¸ Ð²Ñ‹ Ð´ÐµÑ‚ÐµÐ¹?",
            a: "Ð”Ð°, Ð¼Ñ‹ Ð¿Ñ€Ð¸Ð½Ð¸Ð¼Ð°ÐµÐ¼ Ð´ÐµÑ‚ÐµÐ¹ Ñ 3 Ð»ÐµÑ‚. ÐÐ°Ñˆ Ð¿Ð¾Ð´Ñ…Ð¾Ð´ Ð¾ÑÐ½Ð¾Ð²Ð°Ð½ Ð½Ð° Ð¿Ð¾Ð·Ð¸Ñ‚Ð¸Ð²Ð½Ð¾Ð¼ Ð¿ÐµÑ€Ð²Ð¾Ð¼ Ð¾Ð¿Ñ‹Ñ‚Ðµ â€” Ð½Ð¸ÐºÐ°ÐºÐ¾Ð³Ð¾ ÑÑ‚Ñ€Ð°Ñ…Ð° Ð¸ Ð¿Ñ€Ð¸Ð½ÑƒÐ¶Ð´ÐµÐ½Ð¸Ñ. Ð”Ð»Ñ Ð¼Ð°Ð»ÐµÐ½ÑŒÐºÐ¸Ñ… Ð¿Ð°Ñ†Ð¸ÐµÐ½Ñ‚Ð¾Ð² Ð¿Ñ€ÐµÐ´ÑƒÑÐ¼Ð¾Ñ‚Ñ€ÐµÐ½Ñ‹ ÑÐ¿ÐµÑ†Ð¸Ð°Ð»ÑŒÐ½Ñ‹Ðµ Ð¸Ð³Ñ€Ð¾Ð²Ñ‹Ðµ Ð¼ÐµÑ‚Ð¾Ð´Ð¸ÐºÐ¸.",
        },
    ];
function ej({ target: e, suffix: t }) {
    const [n, r] = w.useState(0),
        s = w.useRef(null),
        i = jS(s, { once: !0, margin: "-100px" });
    return (
        w.useEffect(() => {
            if (!i) return;
            let o = 0;
...
function nj() {
    ...
    const y = [
        { href: "#services", label: "Ð£ÑÐ»ÑƒÐ³Ð¸" },
        { href: "#about", label: "Ðž Ð²Ñ€Ð°Ñ‡Ðµ" },
        { href: "#advantages", label: "ÐŸÑ€ÐµÐ¸Ð¼ÑƒÑ‰ÐµÑÑ‚Ð²Ð°" },
        { href: "#testimonials", label: "ÐžÑ‚Ð·Ñ‹Ð²Ñ‹" },
        { href: "#faq", label: "FAQ" },
    ];
    return E.jsxs("div", {
                    ...
                    E.jsxs("div", {
                        ...
                        children: [
                            E.jsxs("a", {
                                ...
                                children: [
                                    E.jsx("span", { className: "text-teal text-2xl", children: "âœ¦" }),
                                    E.jsx("span", {
                                        className: "font-cormorant text-xl font-semibold text-white tracking-wide",
                                        children: "Dr. Ð¡Ð°Ð³Ð¸Ð´Ð°",
                                    }),
                                ],
                            }),
                            E.jsx("nav", {
                            ...
                            E.jsxs("a", {
                                ...
                                children: [E.jsx(Ca, { className: "w-3.5 h-3.5" }), "Ð—Ð°Ð¿Ð¸ÑÐ°Ñ‚ÑŒÑÑ"],
                            }),
                            E.jsx("button", {
                                    ...
                                    children: [
                                        ...
                                        E.jsxs("a", {
                                            ...
                                            children: [
                                                ...
                                                "Ð—Ð°Ð¿Ð¸ÑÐ°Ñ‚ÑŒÑÑ Ð½Ð° Ð¿Ñ€Ð¸ÐµÐ¼",
                                            ],
                                        }),
                                    ],
                                }),
                    ...
                    E.jsxs("div", {
                        ...
                        children: [
                            E.jsx(kt.p, {
                                ...
                                children: "Ð¡Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³Ð¸Ñ‡ÐµÑÐºÐ°Ñ ÐºÐ»Ð¸Ð½Ð¸ÐºÐ°",
                            }),
                            E.jsx(kt.h1, {
                            ...
                            E.jsx(kt.p, {
                                ...
                                children:
                                    "ÐŸÑ€Ð¾Ñ„ÐµÑÑÐ¸Ð¾Ð½Ð°Ð»ÑŒÐ½Ñ‹Ð¹ ÑÑ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³ Ñ Ð·Ð°Ð±Ð¾Ñ‚Ð¾Ð¹ Ð¾ Ð²Ð°ÑˆÐµÐ¹ ÑƒÐ»Ñ‹Ð±ÐºÐµ.",
                            }),
                            E.jsxs(kt.div, {
                        ...
                        E.jsxs(Ze, {
                            ...
                            children: [
                                E.jsx("p", {
                                    ...
                                    children: "Ð§Ñ‚Ð¾ Ð¼Ñ‹ Ð¿Ñ€ÐµÐ´Ð»Ð°Ð³Ð°ÐµÐ¼",
                                }),
                                E.jsxs("h2", {
                                    className: "font-cormorant text-4xl sm:text-5xl lg:text-6xl font-light text-white",
                                    children: [
                                        "ÐÐ°ÑˆÐ¸ ",
                                        E.jsx("span", { className: "italic text-teal", children: "Ð£ÑÐ»ÑƒÐ³Ð¸" }),
                                    ],
                                }),
                            ...
                            children: [
                                E.jsxs("div", {
                                    ...
                                    children: [
                                        E.jsx("img", {
                                            className: "w-full h-full object-cover",
                                            src: "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_0721e7d9f0_727f88d86f00b195.png",
                                ...
                                E.jsxs("div", {
                                    ...
                                    children: [
                                        ...
                                        E.jsx("p", {
                                            ...
                                            children: "Ð»ÐµÑ‚ Ð¿Ñ€Ð°ÐºÑ‚Ð¸ÐºÐ¸",
                                        }),
                                    ],
                                }),
                            ],
                                ...
                                E.jsxs(Ze, {
                                    ...
                                    children: [
                                        E.jsx("p", {
                                            ...
                                            children:
                                                "Ð¡Ð°Ð³Ð¸Ð´Ð° Ð­Ð»ÑŒÐ´Ð°Ñ€Ð¾Ð²Ð½Ð° â€” ÑÐµÑ€Ñ‚Ð¸Ñ„Ð¸Ñ†Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð½Ñ‹Ð¹ ÑÑ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³ Ñ Ð¾Ð¿Ñ‹Ñ‚Ð¾Ð¼ Ñ€Ð°Ð±Ð¾Ñ‚Ñ‹ Ð±Ð¾Ð»ÐµÐµ 12 Ð»ÐµÑ‚. ÐžÐ±ÑƒÑ‡Ð°Ð»Ð°ÑÑŒ Ð² Ð²ÐµÐ´ÑƒÑ‰Ð¸Ñ… ÐºÐ»Ð¸Ð½Ð¸ÐºÐ°Ñ… Ð“ÐµÑ€Ð¼Ð°Ð½Ð¸Ð¸ Ð¸ ÐÐ²ÑÑ‚Ñ€Ð¸Ð¸, ÑÐ²Ð»ÑÐµÑ‚ÑÑ Ð´ÐµÐ¹ÑÑ‚Ð²ÑƒÑŽÑ‰Ð¸Ð¼ Ñ‡Ð»ÐµÐ½Ð¾Ð¼ Ð•Ð²Ñ€Ð¾Ð¿ÐµÐ¹ÑÐºÐ¾Ð¹ Ð°ÑÑÐ¾Ñ†Ð¸Ð°Ñ†Ð¸Ð¸ ÑÑ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³Ð¾Ð².",
                                        }),
                                        E.jsx("p", {
                                            className: "font-karla text-base text-[#0F172A]/70 leading-relaxed mb-8",
                                            children:
                                                "Ð•Ñ‘ Ð¿Ð¾Ð´Ñ…Ð¾Ð´ ÑÐ¾Ñ‡ÐµÑ‚Ð°ÐµÑ‚ Ð²Ñ‹ÑÐ¾Ñ‡Ð°Ð¹ÑˆÐ¸Ð¹ Ð¼ÐµÐ´Ð¸Ñ†Ð¸Ð½ÑÐºÐ¸Ð¹ ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚ Ñ Ð¸Ð½Ð´Ð¸Ð²Ð¸Ð´ÑƒÐ°Ð»ÑŒÐ½Ñ‹Ð¼ Ð²Ð½Ð¸Ð¼Ð°Ð½Ð¸ÐµÐ¼ Ðº ÐºÐ°Ð¶Ð´Ð¾Ð¼Ñƒ Ð¿Ð°Ñ†Ð¸ÐµÐ½Ñ‚Ñƒ. Ð¡Ð¿ÐµÑ†Ð¸Ð°Ð»Ð¸Ð·Ð¸Ñ€ÑƒÐµÑ‚ÑÑ Ð½Ð° ÑÑÑ‚ÐµÑ‚Ð¸Ñ‡ÐµÑÐºÐ¾Ð¹ ÑÑ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³Ð¸Ð¸, Ð¸Ð¼Ð¿Ð»Ð°Ð½Ñ‚Ð°Ñ†Ð¸Ð¸ Ð¸ Ð»ÐµÑ‡ÐµÐ½Ð¸Ð¸ Ð¿Ð°Ñ†Ð¸ÐµÐ½Ñ‚Ð¾Ð² Ñ Ð´ÐµÐ½Ñ‚Ð¾Ñ„Ð¾Ð±Ð¸ÐµÐ¹.",
                                        }),
                                    ],
                                }),
                                E.jsx(Ze, {
                                    ...
                                    children: E.jsx("div", {
                                        ...
                                        children: [
                                            "Ð”Ð¸Ð¿Ð»Ð¾Ð¼ ÐœÐ“ÐœÐ¡Ð£",
                                            "Ð¡Ñ‚Ð°Ð¶Ð¸Ñ€Ð¾Ð²ÐºÐ° Ð² Ð“ÐµÑ€Ð¼Ð°Ð½Ð¸Ð¸",
                                            "Ð§Ð»ÐµÐ½ EDA",
                                            "Ð¡ÐµÑ€Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ‚ Invisalign",
                                        ].map((p) =>
                                            E.jsxs(
                                                "div",
                                                {
                    ...
                    children: [
                        E.jsxs(Ze, {
                            ...
                            children: [
                                E.jsx("p", {
                                    className: "font-karla text-xs text-teal uppercase tracking-[0.3em] mb-3",
                                    children: "Ð¦Ð¸Ñ„Ñ€Ñ‹ Ð³Ð¾Ð²Ð¾Ñ€ÑÑ‚",
                                }),
                                E.jsxs("h2", {
                                    className: "font-cormorant text-4xl sm:text-5xl lg:text-6xl font-light text-white",
                                    children: [
                                        ...
                                        E.jsx("span", {
                                            className: "italic text-teal",
                                            children: "ÐŸÑ€ÐµÐ¸Ð¼ÑƒÑ‰ÐµÑÑ‚Ð²Ð°",
                                        }),
                                    ],
                                }),
                                E.jsx("div", { className: "w-16 h-0.5 bg-teal mx-auto mt-6" }),
                        ...
                        E.jsx("div", {
                            ...
                            children: [
                                {
                                    icon: "ðŸ¥",
                                    title: "Ð•Ð²Ñ€Ð¾Ð¿ÐµÐ¹ÑÐºÐ¸Ð¹ ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚",
                                    desc: "ÐžÐ±Ð¾Ñ€ÑƒÐ´Ð¾Ð²Ð°Ð½Ð¸Ðµ Ð¸ Ð¼Ð°Ñ‚ÐµÑ€Ð¸Ð°Ð»Ñ‹ Ð²ÐµÐ´ÑƒÑ‰Ð¸Ñ… Ð¿Ñ€Ð¾Ð¸Ð·Ð²Ð¾Ð´Ð¸Ñ‚ÐµÐ»ÐµÐ¹ Ð“ÐµÑ€Ð¼Ð°Ð½Ð¸Ð¸, Ð¨Ð²ÐµÐ¹Ñ†Ð°Ñ€Ð¸Ð¸ Ð¸ ÐÐ²ÑÑ‚Ñ€Ð¸Ð¸.",
                                },
                                {
                                    icon: "ðŸ’‰",
                                    title: "Ð‘ÐµÐ·Ð±Ð¾Ð»ÐµÐ·Ð½ÐµÐ½Ð½Ð¾Ðµ Ð»ÐµÑ‡ÐµÐ½Ð¸Ðµ",
                                    desc: "Ð¡Ð¾Ð²Ñ€ÐµÐ¼ÐµÐ½Ð½Ñ‹Ðµ Ð°Ð½ÐµÑÑ‚ÐµÑ‚Ð¸ÐºÐ¸ Ð¸ Ñ‚ÐµÑ…Ð½Ð¾Ð»Ð¾Ð³Ð¸Ð¸ sedation dentistry Ð´Ð»Ñ ÐºÐ¾Ð¼Ñ„Ð¾Ñ€Ñ‚Ð½Ð¾Ð³Ð¾ Ð»ÐµÑ‡ÐµÐ½Ð¸Ñ.",
                                },
                                {
                                    icon: "ðŸ”¬",
                                    title: "Ð¦Ð¸Ñ„Ñ€Ð¾Ð²Ð°Ñ Ð´Ð¸Ð°Ð³Ð½Ð¾ÑÑ‚Ð¸ÐºÐ°",
                                    desc: "3D-Ñ‚Ð¾Ð¼Ð¾Ð³Ñ€Ð°Ñ„Ð¸Ñ, Ñ†Ð¸Ñ„Ñ€Ð¾Ð²Ñ‹Ðµ ÑÐ»ÐµÐ¿ÐºÐ¸ Ð¸ Ð¿Ð»Ð°Ð½Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ðµ ÑƒÐ»Ñ‹Ð±ÐºÐ¸ Ð² Ð¿Ñ€Ð¾Ð³Ñ€Ð°Ð¼Ð¼Ðµ smile design.",
                                },
                            ].map((p, x) =>
                                E.jsx(
                                    Ze,
                    ...
                    children: [
                        E.jsxs(Ze, {
                            ...
                            children: [
                                E.jsx("p", {
                                    className: "font-karla text-xs text-teal uppercase tracking-[0.3em] mb-3",
                                    children: "ÐžÐ½Ð¸ Ð½Ð°Ð¼ Ð´Ð¾Ð²ÐµÑ€ÑÑŽÑ‚",
                                }),
                                E.jsxs("h2", {
                                    className:
                                ...
                                children: _y.map((p, x) =>
                                    E.jsx(
                                        "div",
                                        {
                                            ...
                                            style: {
                                                opacity: d === x ? 1 : 0.4,
                                                transform: `scale(${d === x ? 1 : 0.96})`,
                                            },
                                            children: E.jsxs("div", {
                                                className: "rounded-2xl p-6 lg:p-8 h-full border border-teal/10",
                                                style: {
                                                    backgroundColor: "#fff",
                                                    boxShadow: d === x ? "0 8px 40px rgba(14,165,164,0.12)" : "none",
                                                },
                                                children: [
                                                    E.jsx("div", {
                                ...
                                E.jsx(
                                    "button",
                                    {
                                        ...
                                        style: {
                                            ...
                                            opacity: d === x ? 1 : 0.3,
                                            transform: d === x ? "scale(1.4)" : "scale(1)",
                                        },
                                    },
                                    x
                                )
                    ...
                    children: [
                        E.jsxs(Ze, {
                            ...
                            children: [
                                E.jsx("p", {
                                    className: "font-karla text-xs text-teal uppercase tracking-[0.3em] mb-3",
                                    children: "Ð§Ð°ÑÑ‚Ñ‹Ðµ Ð²Ð¾Ð¿Ñ€Ð¾ÑÑ‹",
                                }),
                                E.jsxs("h2", {
                                    className: "font-cormorant text-4xl sm:text-5xl font-light text-white",
                                    children: [
                                        "Ð’Ð¾Ð¿Ñ€Ð¾ÑÑ‹ ",
                                        E.jsx("span", { className: "italic text-teal", children: "Ð¸ Ð¾Ñ‚Ð²ÐµÑ‚Ñ‹" }),
                                    ],
                                }),
                                E.jsx("div", { className: "w-16 h-0.5 bg-teal mx-auto mt-6" }),
                            ],
                        ...
                        children: [
                            E.jsxs(Ze, {
                                children: [
                                    E.jsx("p", {
                                        ...
                                        children: "ÐÐ°Ñ‡Ð½Ð¸Ñ‚Ðµ ÑÐµÐ¹Ñ‡Ð°Ñ",
                                    }),
                                    E.jsxs("h2", {
                                        className:
                                            "font-cormorant text-4xl sm:text-5xl lg:text-6xl font-light text-white mb-4",
                                        children: [
                                            "Ð’Ð°ÑˆÐ° ÑƒÐ»Ñ‹Ð±ÐºÐ° â€” ",
                                            E.jsx("span", {
                                                className: "italic",
                                                children: "Ð½Ð°Ñˆ Ð¿Ñ€Ð¸Ð¾Ñ€Ð¸Ñ‚ÐµÑ‚",
                                            }),
                                        ],
                                    }),
                                    E.jsx("p", {
                                        ...
                                        children:
                                            "Ð—Ð°Ð¿Ð¸ÑˆÐ¸Ñ‚ÐµÑÑŒ Ð½Ð° Ð¿ÐµÑ€Ð²Ð¸Ñ‡Ð½ÑƒÑŽ ÐºÐ¾Ð½ÑÑƒÐ»ÑŒÑ‚Ð°Ñ†Ð¸ÑŽ Ð¿Ñ€ÑÐ¼Ð¾ ÑÐµÐ¹Ñ‡Ð°Ñ. ÐœÑ‹ Ñ€Ð°Ð±Ð¾Ñ‚Ð°ÐµÐ¼ ÐµÐ¶ÐµÐ´Ð½ÐµÐ²Ð½Ð¾ Ñ 9:00 Ð´Ð¾ 20:00.",
                                    }),
                                ],
                            }),
                            E.jsx(Ze, {
                            ...
                            E.jsx(Ze, {
                                ...
                                children: E.jsx("div", {
                                    ...
                                    children: [
                                        { label: "ÐŸÐ½â€“ÐŸÑ‚", value: "09:00â€“20:00" },
                                        { label: "Ð¡ÑƒÐ±Ð±Ð¾Ñ‚Ð°", value: "10:00â€“18:00" },
                                        { label: "Ð’Ð¾ÑÐºÑ€ÐµÑÐµÐ½ÑŒÐµ", value: "ÐŸÐ¾ Ð·Ð°Ð¿Ð¸ÑÐ¸" },
                                    ].map((p) =>
                                        E.jsxs(
                                            "div",
                                            {
                    ...
                    children: E.jsxs("div", {
                        ...
                        children: [
                            E.jsxs("div", {
                                className: "flex items-center gap-2",
                                children: [
                                    E.jsx("span", { className: "text-teal text-xl", children: "âœ¦" }),
                                    E.jsx("span", {
                                        className: "font-cormorant text-lg font-semibold text-white",
                                        children: "Dr. Ð¡Ð°Ð³Ð¸Ð´Ð° Ð­Ð»ÑŒÐ´Ð°Ñ€Ð¾Ð²Ð½Ð°",
                                    }),
                                ],
                            }),
                            E.jsxs("p", {
                                ...
                                children: [
                                    ...
                                    " Ð¡Ñ‚Ð¾Ð¼Ð°Ñ‚Ð¾Ð»Ð¾Ð³Ð¸Ñ‡ÐµÑÐºÐ°Ñ ÐºÐ»Ð¸Ð½Ð¸ÐºÐ°. Ð’ÑÐµ Ð¿Ñ€Ð°Ð²Ð° Ð·Ð°Ñ‰Ð¸Ñ‰ÐµÐ½Ñ‹.",
                                ],
                            }),
                            E.jsx("div", {
