...
const qO = [
        {
            icon: "🦷",
            title: "Лечение зубов",
            desc: "Современные методы лечения кариеса, пульпита и заболеваний периодонта с использованием передовых европейских материалов.",
                                ...
                                E.jsxs(Ze, {
                                    ...
                                    children: [
                                        E.jsx("p", {
                                            ...
                                            children:
                                                "Сагида Эльдаровна — сертифицированный стоматолог с опытом работы более 2 лет. Обучалась в ведущих клиниках Германии и Австрии, является действующим членом Европейской ассоциации стоматологов.",
                                        }),
                                        E.jsx("p", {
                            ...
                            children: [
                                {
                                    ...
                                    desc: "Оборудование и материалы ведущих производителей Германии, Швейцарии и Австрии.",
                                },
                                {
                                    icon: "💉",
